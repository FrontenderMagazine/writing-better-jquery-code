...
пишете на jQuery и JavaScript, а также, поделиться несколькими ценными 
наблюдениями из моего собственного опыта. Более качественный код означает 
более быстрые приложения и сайты без лишнего мусора. В конце концов, более 
быстрая отрисовка страниц и улучшенное реагирование приносят вашим 
...
## Используйте венгерскую нотацию<a href="#note-1" id="ref-1" class="reference">1</a>
...
## Используйте цепочки переменных (паттерн единичной переменной)
...
## Не используйте подразумеваемый универсальный селектор
